...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Yᴏᴜʀ ᴍᴇssᴀɢᴇ ʜᴀs ʙᴇᴇɴ sᴇɴᴛ ᴛᴏ ᴍʏ ᴍᴏᴅᴇʀᴀᴛᴏʀs.Dᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴀɴʏ ᴍᴏᴠɪᴇ. Pʟᴇᴀsᴇ Rᴇǫᴜᴇsᴛ Oɴ @MZ_MOVIEZZGRP</b>")
    ...
    if query.data.startswith("file"):
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              ...
                              InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Movies_zone_admin")
                             ]
                            ]
                        )
                    )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Movies_zone_admin")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
