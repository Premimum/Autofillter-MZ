...
• ꜰᴜʟʟ ɴᴀᴍᴇ : Mz Movies Controller
• ᴜꜱᴇʀɴᴀᴍᴇ : @Movies_zone_admin
• Dᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/BotX_Creator'>Rᴏʟᴇx ᠰ TɢX</a></b>"""
...
📅 Dᴀᴛᴇ : <code>{}</code>
⏰ Tɪᴍᴇ : <code>{}</code>
🌐 Tɪᴍᴇᴢᴏɴᴇ : <code>India/Kerala</code>
